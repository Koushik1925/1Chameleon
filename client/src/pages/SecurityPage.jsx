            ...
            <div className="relative z-10 pb-24">
                ...
                <section className="px-6 max-w-7xl mx-auto mb-20 border-t border-white/5 pt-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-[#111827]/72 border border-white/6 hover:border-[#22C55E]/35 rounded-[18px] p-8 backdrop-blur-[12px] hover:-translate-y-1.5 hover:shadow-[0_15px_40px_rgba(0,0,0,0.45)] transition-all duration-150 ease-out">
                            ...
                            <h3 className="text-xl font-bold text-[#F3F4F6] mb-3">End-to-End Encryption</h3>
                        ...
                        <div className="bg-[#111827]/72 border border-white/6 hover:border-[#3B82F6]/35 rounded-[18px] p-8 backdrop-blur-[12px] hover:-translate-y-1.5 hover:shadow-[0_15px_40px_rgba(0,0,0,0.45)] transition-all duration-150 ease-out">
                            ...
                            <h3 className="text-xl font-bold text-[#F3F4F6] mb-3">TLS 1.3 Signaling</h3>
                            <p className="text-[#9CA3AF] text-sm leading-relaxed">
                                Signaling exchanges (SDP offers, answers, and ICE candidate discovery) take place over secure WebSockets TLS 1.3 channels.
                            </p>
                        </div>

                        <div className="bg-[#111827]/72 border border-white/6 hover:border-[#8B5CF6]/35 rounded-[18px] p-8 backdrop-blur-[12px] hover:-translate-y-1.5 hover:shadow-[0_15px_40px_rgba(0,0,0,0.45)] transition-all duration-150 ease-out">
                            ...
                            <h3 className="text-xl font-bold text-[#F3F4F6] mb-3">Cryptographic Device Identity</h3>
                            <p className="text-[#9CA3AF] text-sm leading-relaxed">
                ...
                <section className="px-6 max-w-5xl mx-auto mb-20 space-y-8">
                    <div className="bg-[#111827]/72 border border-white/6 rounded-[18px] p-8 md:p-12 backdrop-blur-[12px] space-y-6 shadow-[0_15px_40px_rgba(0,0,0,0.45)]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-[#9CA3AF]">
                            <div>
                                <h4 className="font-bold text-[#F3F4F6] text-base mb-2">Session Approval Badges</h4>
                                <p className="leading-relaxed text-[#9CA3AF]">
                                    When an incoming connection is requested, the Desktop Agent displays an explicit green approval banner. Remote control can be paused instantly using global hotkey <code className="text-[#06B6D4] font-mono bg-[#090D17] border border-white/5 px-2 py-0.5 rounded-lg">Ctrl+Alt+P</code>.
                                </p>
                            </div>

                            <div>
                                <h4 className="font-bold text-[#F3F4F6] text-base mb-2">Unattended Access Protection</h4>
                                <p className="leading-relaxed text-[#9CA3AF]">
                            ...
                            <div>
                                <h4 className="font-bold text-[#F3F4F6] text-base mb-2">Zero Screen Recording</h4>
                                <p className="leading-relaxed text-[#9CA3AF]">
                            ...
                            <div>
                                <h4 className="font-bold text-[#F3F4F6] text-base mb-2">Future Security Roadmap</h4>
                                <p className="leading-relaxed text-[#9CA3AF]">
                    ...
                    <div className="bg-[#111827]/72 border border-white/6 rounded-[18px] p-8 backdrop-blur-[12px] flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 px-5 py-2.5 bg-amber-500/20 border border-amber-500/30 hover:bg-amber-500/30 text-amber-300 font-bold text-xs rounded-xl transition-colors duration-150 ease-out"
                            >
