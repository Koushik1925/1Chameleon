...
export default function DeleteAccountPage() {
    return (
        <div className="min-h-screen bg-[#0B0F1A] text-[#E5E7EB] font-sans selection:bg-red-500/30 selection:text-red-200">
            <SEOHead 
            ...
            <div className="relative z-10 pb-20">
                ...
                <div className="px-6 max-w-4xl mx-auto space-y-8">
                    ...
                    {/* Warning Banner (Red used ONLY for destructive warnings) */}
                    <div className="bg-red-950/30 border border-red-500/30 rounded-2xl p-8 backdrop-blur-xl flex items-start gap-4">
                        <div className="w-12 h-12 rounded-xl bg-red-500/20 text-red-400 flex items-center justify-center shrink-0">
                            <AlertTriangle size={24} />
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-[#E5E7EB] mb-2">Permanent Account Deletion Warning</h3>
                        ...
                        <div className="bg-[#111827] border border-[#1F2937] rounded-2xl p-8 backdrop-blur-xl space-y-4">
                            ...
                            <ul className="space-y-2 text-sm text-[#9CA3AF]">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span><strong className="text-[#E5E7EB]">Immediate Effect:</strong> Account is deactivated and unlinked from claimed host agents.</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#06B6D4] mt-2 shrink-0"></span>
                                    <span><strong className="text-[#E5E7EB]">30-Day Purge Window:</strong> Data is completely overwritten and permanently removed from MongoDB Atlas backups within 30 days.</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#06B6D4] mt-2 shrink-0"></span>
                                    <span><strong className="text-[#E5E7EB]">Recovery Period:</strong> You may cancel deletion within 14 days by emailing support.</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="bg-[#111827] border border-[#1F2937] rounded-2xl p-8 md:p-10 backdrop-blur-xl space-y-6">
                        <h3 className="text-2xl font-bold text-[#E5E7EB]">How to Submit Account Deletion Request</h3>
                        
                        <div className="space-y-4 text-[#9CA3AF] text-sm">
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-xl bg-[#0B0F1A] border border-[#1F2937] text-[#06B6D4] flex items-center justify-center font-mono font-bold shrink-0">1</div>
                                <div>
                                    <h4 className="font-bold text-[#E5E7EB]">Unclaim Host Devices</h4>
                            ...
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-xl bg-[#0B0F1A] border border-[#1F2937] text-[#06B6D4] flex items-center justify-center font-mono font-bold shrink-0">2</div>
                                <div>
                                    <h4 className="font-bold text-[#E5E7EB]">Send Deletion Email Request</h4>
                            ...
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-xl bg-[#0B0F1A] border border-[#1F2937] text-[#06B6D4] flex items-center justify-center font-mono font-bold shrink-0">3</div>
                                <div>
                                    <h4 className="font-bold text-[#E5E7EB]">Confirmation & Deactivation</h4>
                        ...
                        <div className="pt-4 border-t border-[#1F2937] flex flex-col sm:flex-row items-center justify-between gap-4">
                            <a 
                                href="mailto:chameleonagent.contact@gmail.com?subject=Account Deletion Request"
                                className="w-full sm:w-auto px-6 py-3 bg-red-600 hover:bg-red-500 text-white font-bold rounded-xl text-sm flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(239,68,68,0.25)] active:scale-98 transition-all"
                            >
                                <Trash2 size={18} />
