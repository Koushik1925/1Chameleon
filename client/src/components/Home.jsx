            ...
            <div className="relative z-10">
                ...
                <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#0b0f14]/80 backdrop-blur-md border-b border-white/5 py-0' : 'bg-transparent border-transparent py-2'}`}>
                    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                        ...
                        <div className="flex gap-4">
                            <a href="#download" className="text-sm font-medium text-slate-300 hover:text-white transition-colors flex items-center h-9 px-4 rounded-lg hover:bg-white/5 underline hover:no-underline">
                                Download Agent
                            </a>
                            <Link to="/connect" className="text-sm font-medium text-black bg-cyan-400 hover:bg-cyan-300 transition-colors flex items-center h-9 px-4 rounded-lg shadow-[0_0_15px_rgba(6,182,212,0.3)] no-underline">
                                Connect
                            </Link>
                        </div>
                    </div>
                    ...
                    <section className="pt-40 pb-20 px-6 min-h-[90vh] flex flex-col items-center justify-center text-center">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-6">
                                ...
                                <a href="#download" className="h-12 px-8 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium flex items-center justify-center gap-2 transition-all underline hover:no-underline">
                    ...
                    <section className="py-24 px-6 border-t border-white/5 bg-black/30">
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-slate-300">Three steps to full system control.</p>
                            </div>
                                ...
                                {[
                                    ...
                                    <div key={i} className="bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-sm hover:border-cyan-500/30 transition-colors group">
                                        <div className="flex justify-between items-start mb-6">
                                            ...
                                            <span className="text-4xl font-black text-white/80">{item.step}</span>
                                        </div>
                    ...
                    <section className="py-24 px-6">
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-slate-300">Built for uncompromising speed and security.</p>
                            </div>
                            ...
                            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div key={i} className="p-6 rounded-2xl border border-white/5 bg-gradient-to-b from-white/[0.03] to-transparent">
                                        <h3 className="text-cyan-400 font-medium text-sm mb-2">{feat.title}</h3>
                    ...
                    <section id="download" className="py-24 px-6 scroll-mt-16">
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-slate-300">The lightweight host application required to share your screen.</p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-[#111827] border border-slate-800 p-8 rounded-3xl flex flex-col items-center text-center relative overflow-hidden group">
                                    ...
                                    <a href="/Chameleon-Agent-Setup-Legacy.exe" download className="mt-4 text-[10px] text-slate-400 hover:text-cyan-400 underline transition-colors relative z-10 hover:no-underline">
                ...
                <footer className="border-t border-white/5 bg-black pt-16 pb-8 px-6 text-center">
                    <div className="max-w-2xl mx-auto mb-16">
                        ...
                        <h2 className="text-xl font-semibold mb-3">Your screen is yours.</h2>
                    ...
                    <div className="max-w-7xl mx-auto border-t border-white/5 pt-12 mt-8 flex flex-col items-center justify-center text-xs text-slate-400 font-medium tracking-wide">
                        <div className="mb-2 text-slate-300">Chameleon © {new Date().getFullYear()}</div>
                        <div>
                            Contact Us —{' '}
                            <a
                                href="mailto:chameleonagent.contact@gmail.com"
                                className="text-slate-300 hover:text-cyan-400 hover:drop-shadow-[0_0_8px_rgba(34,211,238,0.6)] transition-all duration-300 underline hover:no-underline"
                            >
