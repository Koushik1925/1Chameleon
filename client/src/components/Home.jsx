                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-[#111827] border border-slate-800 p-8 rounded-3xl flex flex-col items-center text-center relative overflow-hidden group">
                                ...
                                <a href="/Chameleon-Agent-Setup-1.2.0.exe" download className="w-full py-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-medium transition-colors z-10 relative">
                                    <div className="flex items-center justify-center gap-3">
                                        <MonitorSmartphone className="w-5 h-5" />
                                        Download for Windows
                                    </div>
                                </a>
                                <span className="text-xs text-slate-600 mt-4 font-mono">v1.2.0 • ~85 MB</span>
                            ...
                            <div className="bg-[#111827] border border-slate-800 p-8 rounded-3xl flex flex-col items-center text-center relative overflow-hidden group">
                                ...
                                <a href="/Chameleon-Agent-macOS-1.2.0.dmg" download className="w-full py-4 rounded-xl bg-white/10 hover:bg-white/20 border border-white/10 text-white font-medium transition-colors z-10 relative">
                                    <div className="flex items-center justify-center gap-3">
                                        <Apple className="w-5 h-5" />
                                        Download for macOS
                                    </div>
                                </a>
                                <span className="text-xs text-slate-600 mt-4 font-mono">v1.2.0 • ~95 MB</span>
                                <div className="mt-3 flex items-center justify-center gap-1.5 text-[10px] text-green-500/70 uppercase tracking-widest font-bold">
                                    <ShieldCheck size={12} /> Verified & Secure
                                </div>
                            </div>
