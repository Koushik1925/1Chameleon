        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8 relative z-20">
            ...
            <div className="pt-8 flex flex-wrap justify-center items-center gap-6 text-xs font-medium text-slate-300">
              ...
              <span>•</span>
              <span className="flex items-center space-x-1.5"><Monitor className="w-4 h-4 text-blue-400" /> <span>Linux</span></span>
              <span>•</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-1 space-y-4 text-left">
              ...
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" /> <span>Sub-100ms Glass-to-Glass Latency</span></li>
                ...
                <li className="flex items-center space-x-2"><CheckCircle2 className="w-4 h-4 text-purple-400 shrink-0" /> <span>Dual WebRTC DataChannels</span></li>
              </ul>
            </div>
